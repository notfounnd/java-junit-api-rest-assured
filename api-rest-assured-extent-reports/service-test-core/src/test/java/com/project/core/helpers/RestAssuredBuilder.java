...
public class RestAssuredBuilder {
	...
	public static void setRestAssured(String prefix, ApplicationProperties PROPERTIES) {
		RestAssuredBuilder.setBaseURI(PROPERTIES.getProperty(prefix + ".test.base.url"));
		RestAssuredBuilder.setBasePort(PROPERTIES.getProperty(prefix + ".test.base.port"));
		RestAssuredBuilder.setBasePath(PROPERTIES.getProperty(prefix + ".test.base.path"));

		RequestSpecBuilder requestSpecBuilder = new RequestSpecBuilder();
		requestSpecBuilder = RestAssuredBuilder.setBaseContentType(requestSpecBuilder, PROPERTIES.getProperty(prefix + ".test.base.contentType"));
		RestAssured.requestSpecification = requestSpecBuilder.build();

		ResponseSpecBuilder responseSpecBuilder = new ResponseSpecBuilder();
		responseSpecBuilder = RestAssuredBuilder.setBaseMaxTimeout(responseSpecBuilder, PROPERTIES.getProperty(prefix + ".test.base.maxTimeout"));
		responseSpecBuilder = RestAssuredBuilder.setBaseParser(responseSpecBuilder, PROPERTIES.getProperty(prefix + ".test.base.parser"));
